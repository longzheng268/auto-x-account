...
impl I18n {
    pub fn new(language: &str) -> Self {
        ...
        zh_cn.insert(
            "waiting_verification".to_string(),
            "等待验证码...".to_string(),
        );
        zh_cn.insert(
            "verification_received".to_string(),
            "已收到验证码".to_string(),
        );
        ...
        en_us.insert(
            "app_name".to_string(),
            "X Account Auto Registration System".to_string(),
        );
        en_us.insert("starting".to_string(), "Starting...".to_string());
        en_us.insert(
            "smtp_starting".to_string(),
            "Starting SMTP server...".to_string(),
        );
        en_us.insert(
            "smtp_started".to_string(),
            "SMTP server started".to_string(),
        );
        en_us.insert(
            "smtp_stopped".to_string(),
            "SMTP server stopped".to_string(),
        );
        en_us.insert(
            "browser_init".to_string(),
            "Initializing browser...".to_string(),
        );
        ...
        en_us.insert(
            ...
            "Starting account registration".to_string(),
        );
        en_us.insert(
            "registration_success".to_string(),
        ...
        en_us.insert(
            "waiting_verification".to_string(),
            "Waiting for verification code...".to_string(),
        );
        en_us.insert(
            "verification_received".to_string(),
            "Verification code received".to_string(),
        );
